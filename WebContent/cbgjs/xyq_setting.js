...
var PRIMARY_YAO_JUE = [ "反击", "反震", "吸血", "连击", "飞行", "夜战", "隐身", "感知", "再生",
		"冥思", "慧根", "必杀", "幸运", "神迹", "招架", "永恒", "敏捷", "强力", "防御", "偷袭", "毒",
		"驱鬼", "鬼魂术", "魔之心", "神佑复生", "精神集中", "否定信仰", "雷击", "落岩", "水攻", "烈火",
		"法术连击", "法术暴击", "法术波动", "雷属性吸收", "土属性吸收", "火属性吸收", "水属性吸收", "迟钝" ];
var SENIOR_YAO_JUE = [ "高级反击", "高级反震", "高级吸血", "高级连击", "高级飞行", "高级夜战", "高级隐身",
		"高级感知", "高级再生", "高级冥思", "高级慧根", "高级必杀", "高级幸运", "高级神迹", "高级招架", "高级永恒",
		"高级敏捷", "高级强力", "高级防御", "高级偷袭", "高级毒", "高级驱鬼", "高级鬼魂术", "高级魔之心",
		"高级神佑复生", "高级精神集中", "高级否定信仰", "奔雷咒", "泰山压顶", "水漫金山", "地狱烈火", "高级雷属性吸收",
		"高级土属性吸收", "高级火属性吸收", "高级水属性吸收", "高级法术连击", "高级法术暴击", "高级法术波动", "壁垒击破",
		"嗜血追击" ];
...
var SaleNeidanSkills = [ '神机步', '腾挪劲', '玄武躯', '龙胄铠', '玉砥柱', '碎甲刃', '阴阳护',
		'凛冽气', '舍身击', '电魂闪', '通灵法', '双星爆', '催心浪', '隐匿击', '生死决', '血债偿' ];
...
function get_pet_ext_zz(data, options) {
	if (data.pet_name.indexOf('超级') === 0 && data.lifetime === '永生') {
		return;
	}
	options = Object
			.merge(
